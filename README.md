...
# Microsoft eShopOnWeb ASP.NET With Feature Flags Core Reference Application
...
**It also shows how to use Unlaunch feature flags in .NET Core / ASP.NET to control feature visibility.**
